...
(s, c \land s \sim \langle \ l \colon t | tail\_s \ \rangle \land s \sim u)
}
\]

This gives the rule in our system equivalent to
[[https://www.microsoft.com/en-us/research/publication/extensible-records-with-scoped-labels/][Leijen05]]'s
