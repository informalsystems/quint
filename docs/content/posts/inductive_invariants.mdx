...
date: 2025-07-31
excerpt: Learn about inductive invariants by defining them interactively with new Quint tools.
authors:
    - name: Josef Widder
...
- If it is, then we call `send_to_next` and assign the resulting receiver and payload to a new message in the network, and update the local state of the process in the system
