...
**Input:** Existing Tendermint spec + Manu's English protocol description<br />**Process:** AI modifies the Quint spec based on the new protocol<br />**Output:** First version of Fast Tendermint spec
