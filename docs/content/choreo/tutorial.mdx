...
- Choreo files downloaded ([choreo.qnt](https://github.com/informalsystems/choreo/blob/main/choreo.qnt) and [template.qnt](https://github.com/informalsystems/choreo/blob/main/template.qnt))
